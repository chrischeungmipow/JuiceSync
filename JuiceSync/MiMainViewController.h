...
#import "BlueToothMe/MiBlueToothGlobal.h"
#import "MiSound.h"
#import "MiLiquidView.h"
#import "MiTempLiquidView.h"
...
@property (nonatomic, weak) CBPeripheral *myPeriphMain;
...
@property(nonatomic,strong)MiTempLiquidView * tempLiquidView;
